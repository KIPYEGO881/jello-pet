    ...
    <title>Jello</title>
    <link rel="icon" type="image/x-icon" href="/images/jello_vet.png">
	<!-- core CSS -->
...
<!--*********************************************START OF NAVIGATION BAR****************************************--> 
        ...
        ?>
                    ...
                    <td  style="border: 1px dashed #8c8b8b;"><center><strong class="wow fadeInDown"><p style="margin-top:25px;">No.<?php echo $count;?></p></strong></center></td>
                        ...
                        <td style="border: 1px dashed #8c8b8b;"><button class="btn btn-success  wow fadeInDown" name="order" type="button" style="margin-top:25px;" data-toggle="modal" data-target="#orderModal<?php echo $id;?>"><i class="glyphicon glyphicon-shopping-cart">

                                </i> Add to Cart</button></td>
                    </tr>
                     <!-- Modal -->
